...
if(isset($_POST["data"]))
{
    ...
    {  
        ...
        echo '<td><button class="btn btn-success delete-row" id="'.$finalString.'" onclick="commonOperations(this)">Activate</button>
        <button class="btn btn-danger delete-row" id="'.$finalString.'" onclick="commonOperations(this)">Deactivate</button>
        </td>';
        echo '</tr>';
    }
    echo '</table>';
