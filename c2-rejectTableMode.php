...
if(isset($_POST["data"]))
{
    ...
    {  
        ...
        echo '<td>
            <button class="btn btn-success delete-row" id="'.$finalString.'" onclick="commonOperations(this)">Approve</button>
            <button class="btn btn-danger delete-row" id="'.$finalString.'" onclick="commonOperations(this)">Reject</button>
            </td>';
